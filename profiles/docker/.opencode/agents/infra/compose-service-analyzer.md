...
- Fixed `container_name:` set on a service — pins the name and blocks running multiple instances/projects side by side; let Compose generate names.
...
- Flag fixed `container_name:` on services as WARNING.
